...
Modify basic_auth.csv and reset the K8S API server.
    ...
    SetMainAuth.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setMainAuth',
        http_method='POST',
        method_id='container.projects.locations.clusters.setMainAuth',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:setMainAuth',
        request_field='<request>',
        request_type_name='SetMainAuthRequest',
        response_type_name='Operation',
        supports_download=False,
    )
    ...
    UpdateMain.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1alpha1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:updateMain',
        http_method='POST',
        method_id='container.projects.locations.clusters.updateMain',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1alpha1/{+name}:updateMain',
        request_field='<request>',
        request_type_name='UpdateMainRequest',
        response_type_name='Operation',
        supports_download=False,
    )
...
instead.
    ...
    Main.method_config = lambda: base_api.ApiMethodInfo(
        http_method='POST',
        method_id='container.projects.zones.clusters.main',
        ordered_params=['projectId', 'zone', 'clusterId'],
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1alpha1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/main',
        request_field='<request>',
        request_type_name='UpdateMainRequest',
        response_type_name='Operation',
        supports_download=False,
...
Modify basic_auth.csv and reset the K8S API server.
    ...
    SetMainAuth.method_config = lambda: base_api.ApiMethodInfo(
        http_method='POST',
        method_id='container.projects.zones.clusters.setMainAuth',
        ordered_params=['projectId', 'zone', 'clusterId'],
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1alpha1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:setMainAuth',
        request_field='<request>',
        request_type_name='SetMainAuthRequest',
        response_type_name='Operation',
        supports_download=False,
