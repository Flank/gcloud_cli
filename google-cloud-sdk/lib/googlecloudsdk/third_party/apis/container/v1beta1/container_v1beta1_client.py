...
the password.
    ...
    SetMainAuth.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:setMainAuth',
        http_method='POST',
        method_id='container.projects.locations.clusters.setMainAuth',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:setMainAuth',
        request_field='<request>',
    ...
    UpdateMain.method_config = lambda: base_api.ApiMethodInfo(
        flat_path='v1beta1/projects/{projectsId}/locations/{locationsId}/clusters/{clustersId}:updateMain',
        http_method='POST',
        method_id='container.projects.locations.clusters.updateMain',
        ordered_params=['name'],
        path_params=['name'],
        query_params=[],
        relative_path='v1beta1/{+name}:updateMain',
        request_field='<request>',
...
instead.
    ...
    Main.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/main',
        request_field='<request>',
        request_type_name='UpdateMainRequest',
        response_type_name='Operation',
        supports_download=False,
...
the password.
    ...
    SetMainAuth.method_config = lambda: base_api.ApiMethodInfo(
        ...
        path_params=['clusterId', 'projectId', 'zone'],
        query_params=[],
        relative_path='v1beta1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:setMainAuth',
        request_field='<request>',
        request_type_name='SetMainAuthRequest',
        response_type_name='Operation',
        supports_download=False,
