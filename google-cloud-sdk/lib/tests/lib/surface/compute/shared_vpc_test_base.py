...
"""Base class for tests for `gcloud compute shared-vpc` commands."""
...
class SharedVpcTestBase(cli_test_base.CliTestBase, parameterized.TestCase):
  """Base class for shared-vpc tests."""
...
class SharedVpcApitoolsTestBase(sdk_test_base.WithFakeAuth,
