...
"""Test base for compute maintenance policies unit tests."""
...
class TestBase(test_base.BaseTest):
  """Base class for maintenance policies tests."""
  ...
  def MakeMaintenancePolicy(self, name, days_in_cycle, start_time,
                            description=None, creation_timestamp=None):
    vm_policy = self.messages.VmMaintenancePolicy(
    ...
    return self.messages.MaintenancePolicy(
