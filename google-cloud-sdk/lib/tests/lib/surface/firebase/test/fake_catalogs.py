...
"""Fake device catalogs for testing."""
...
def FakeAndroidCatalog():
  """Returns a fake Android device catalog containing two models."""
  ...
  android_version_3 = TESTING_MESSAGES.AndroidVersion(
      apiLevel=3,
      codeName='Cupcake',
      distribution=TESTING_MESSAGES.Distribution(marketShare=12.3,
                                                 measurementTime='nigh'),
      id='C',
