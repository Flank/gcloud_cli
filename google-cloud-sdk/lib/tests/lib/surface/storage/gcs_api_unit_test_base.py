...
"""Base class for gcloud storage surface unit tests.

Similar to gsutil/gslib/tests/testcase/unit_testcase.py
"""
...
class GcsApiUnitTestBase(StorageTestBase, sdk_test_base.WithFakeAuth):
  """Base class for gcloud storage surface unit tests."""
