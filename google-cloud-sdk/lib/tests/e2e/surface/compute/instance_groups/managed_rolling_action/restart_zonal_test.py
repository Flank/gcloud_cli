...
"""Managed Instance Group Updater zonal restart e2e test."""
...
class RestartZonalTest(
  ...
  def testUpdateInstancesRestartZonal(self):
    self.prefix = 'managed-instance-group-updater-1'
    self.scope = e2e_test_base.ZONAL
    self._RunUpdateInstancesRestartTest(3)
