...
"""Managed Instance Group Updater regional replace e2e test."""
...
class ReplaceRegionalTest(
  ...
  def testUpdateInstancesReplaceRegional(self):
    self.prefix = 'managed-instance-group-updater-6'
