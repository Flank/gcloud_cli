...
class RestartRegionalTest(
  ...
  def testUpdateInstancesRestartRegional(self):
    self.prefix = 'managed-instance-group-updater-2'
    self.scope = e2e_test_base.REGIONAL
    self._RunUpdateInstancesRestartTest(10)
