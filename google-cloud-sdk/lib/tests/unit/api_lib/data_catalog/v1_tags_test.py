...
class TagsTest(sdk_test_base.WithFakeAuth):
  ...
  def SetUp(self):
    self.client = tags_v1.TagsClient()

  def test_GetFieldType_Primitive(self):
    primitive_field_type_enum = (
        self.client.messages.GoogleCloudDatacatalogV1FieldType
  ...
  def test_ParseFieldType_Enum(self):
    message_type = self.client.messages.GoogleCloudDatacatalogV1FieldType(
        enumType=(
  ...
  def test_MakeTagField_Primitive(self):
    tag_field = self.client.messages.GoogleCloudDatacatalogV1TagField
