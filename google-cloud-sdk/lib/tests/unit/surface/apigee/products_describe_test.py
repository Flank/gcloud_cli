...
"""Tests that exercise the 'gcloud apigee products describe' command."""
...
class ProductsDescribeTest(base.ApigeeSurfaceTest):
  ...
  def testSimpleDescribe(self):
    ...
    self.RunApigee("products describe gcloud-test3 "
