...
"""Tests for surface.billing.projects.describe ."""
...
class AccountsProjectsDescribeTest(base.BillingMockNoDisplayTest):

  def SetUp(self):
    self.track = calliope_base.ReleaseTrack.BETA

  def testDescribe(self):
    self.mocked_billing.projects.GetBillingInfo.Expect(
    ...
    self.assertEqual(
        self.Run('billing projects describe {project_id}'.format(
            project_id=base.PROJECTS[0].projectId,
        )),
        base.PROJECTS[0],
    )
