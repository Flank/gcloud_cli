...
"""Tests for Spanner instances delete command."""
...
class InstancesDeleteTest(base.SpannerTestBase):
  """Cloud Spanner instances delete tests."""
  ...
  def testDelete(self):
    ...
    self.Run('spanner instances delete insId')
