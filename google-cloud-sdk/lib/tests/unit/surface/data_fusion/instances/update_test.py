...
"""Unit tests for instance update."""
...
class InstancesUpdateBetaTest(base.InstancesUnitTest):
  ...
  def testSuccessfulUpdate(self):
    ...
    self.RunInstances('update', '--project', self.TEST_PROJECT,
