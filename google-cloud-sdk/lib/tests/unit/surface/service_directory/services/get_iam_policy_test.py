...
"""Tests for `gcloud service-directory services get-iam-policy`."""
...
class GetIamPolicyTestBeta(base.ServiceDirectoryUnitTestBase):
  ...
  def SetUp(self):
    self.service_name = 'projects/fake-project/locations/my-location/namespaces/my-namespace/services/my-service'
  ...
  def _ExpectGetIamPolicy(self):
    self.client.projects_locations_namespaces_services.GetIamPolicy.Expect(
        request=self.msgs
        .ServicedirectoryProjectsLocationsNamespacesServicesGetIamPolicyRequest(
  ...
  def testGetIamPolicy(self):
    ...
    result = self.Run('service-directory services get-iam-policy my-service '
                      '--format=disable '
  ...
  def testListCommandFilter(self):
    ...
    self.Run('service-directory services get-iam-policy my-service '
             '--namespace my-namespace '
             '--location my-location '
  ...
  def testGetIamPolicy_RelativeName(self):
    ...
    result = self.Run(
        'service-directory services get-iam-policy --format=disable {}'.format(
            self.service_name))
