...
"""Tests for google3.third_party.py.tests.unit.surface.ai.hp_tuning_jobs.list."""
...
class ListHptuningJobUnitTestAlpha(cli_test_base.CliTestBase,
  ...
  def _buildHptuningJob(
      ...
      display_name='ListHptuningJobUnitTest',
      max_trial_count=1,
    ...
    expected_hptuning_spec.name = name

    return expected_hptuning_spec

  def testListHptuningJob(self):
    request = self.messages.AiplatformProjectsLocationsHyperparameterTuningJobsListRequest(
        pageSize=100,
        parent='projects/{}/locations/{}'.format('fake-project', 'us-central1'))
    expected_response = self.messages.GoogleCloudAiplatformV1beta1ListHyperparameterTuningJobsResponse(
        hyperparameterTuningJobs=[
            self._buildHptuningJob(
            ...
            self._buildHptuningJob(
                ...
                name='projects/fake-project/locations/us-central1/hyperparameterTuningJobs/2',
                display_name=u'ListHptuningJobUnitTest2')
        ])
    self.mock_client.projects_locations_hyperparameterTuningJobs.List.Expect(
    ...
    self.AssertOutputContains('displayName: ListHptuningJobUnitTest')
    self.AssertOutputContains(
        'name: projects/fake-project/locations/us-central1/hyperparameterTuningJobs/2'
    )
    self.AssertOutputContains('displayName: ListHptuningJobUnitTest2')


class ListHptuningJobUnitTestBeta(ListHptuningJobUnitTestAlpha):
