...
"""Unit tests for environments storage dags import."""
...
class EnvironmentsStorageDagsImportGATest(base.GsutilShellingUnitTest,
  ...
  def testDagsImport(self, use_gsutil, exec_mock):
    ...
    self.RunEnvironments('storage', 'dags', 'import',
...
class EnvironmentsStorageDagsImportBetaTest(
    EnvironmentsStorageDagsImportGATest):

  def PreSetUp(self):
    self.SetTrack(calliope_base.ReleaseTrack.BETA)


class EnvironmentsStorageDagsImportAlphaTest(
    EnvironmentsStorageDagsImportBetaTest):
