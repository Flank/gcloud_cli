...
"""Unit tests for environments storage plugins delete."""
...
class EnvironmentsStoragePluginsDeleteTest(base.GsutilShellingUnitTest,
  ...
  def testPluginsDeleteTargetSpecified(self, exec_mock):
  ...
  def testPluginsDeleteTargetNotSpecified(self, exec_mock):
  ...
  def testPluginsDeleteRestoresSubdir(self, exec_mock):
