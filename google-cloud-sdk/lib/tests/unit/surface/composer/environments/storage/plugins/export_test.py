...
class EnvironmentsStoragePluginsExportTest(base.GsutilShellingUnitTest,
                                           parameterized.TestCase):

  @mock.patch('googlecloudsdk.core.execution_utils.Exec')
  @mock.patch('os.path.isdir', return_value=True)
  def testPluginsExport(self, track, isdir_mock, exec_mock):
  ...
  @mock.patch('googlecloudsdk.core.execution_utils.Exec')
  @mock.patch('os.path.isdir', return_value=True)
  def testPluginsExportWildcardSource(self, track, isdir_mock, exec_mock):
