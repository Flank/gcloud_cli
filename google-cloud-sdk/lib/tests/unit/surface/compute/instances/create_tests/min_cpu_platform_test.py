...
class InstancesCreateMinCpuPlatformAlpha(
...
class InstancesCreateMinCpuPlatformBeta(create_test_base.InstancesCreateTestBase
                                       ):
...
class InstancesCreateMinCpuPlatformGA(create_test_base.InstancesCreateTestBase):
