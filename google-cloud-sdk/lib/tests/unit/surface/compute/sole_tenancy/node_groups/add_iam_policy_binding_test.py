...
"""compute node groups add-iam-policy-binding tests."""
...
class AddIamPolicyBindingTest(sdk_test_base.WithFakeAuth,
  ...
  def testAddOwnerToNodeGroup(self, track, api_version):
    ...
    self.Run("""
        compute sole-tenancy node-groups add-iam-policy-binding my-resource
        --zone=fake-zone --member user:testuser@google.com --role owner
        """)
