...
"""compute node groups get-iam-policy tests."""
...
class GetIamPolicyUnitTest(sdk_test_base.WithFakeAuth,
  ...
  def testEmptyPolicyCase(self, track, api_version):
    ...
    self.Run('compute sole-tenancy node-groups get-iam-policy '
  ...
  def testListCommandFilter(self, track, api_version):
    ...
    self.Run("""
        compute sole-tenancy node-groups get-iam-policy my-resource
        --zone=fake-zone
