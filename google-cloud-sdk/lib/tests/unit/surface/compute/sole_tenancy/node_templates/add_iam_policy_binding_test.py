...
"""compute node templates add-iam-policy-binding tests."""
...
class AddIamPolicyBindingTest(sdk_test_base.WithFakeAuth,
  ...
  def testAddOwnerToNodeTemplate(self, track, api_version):
    ...
    self.Run('compute sole-tenancy node-templates add-iam-policy-binding '
