...
class ConnectorsDescribeTestGa(base.VpcAccessUnitTestBase):
...
class ConnectorsDescribeTestBeta(ConnectorsDescribeTestGa):
...
class ConnectorsDescribeTestAlpha(ConnectorsDescribeTestGa):
