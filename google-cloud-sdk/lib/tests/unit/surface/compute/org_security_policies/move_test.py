...
"""Tests for the organization security policy move subcommand."""
...
class OrgSecurityPoliciesMoveBetaTest(sdk_test_base.WithFakeAuth,
  ...
  def testMoveOrgSecurityPolicy(self):
    self.mock_client.organizationSecurityPolicies.Move.Expect(
        self.messages.ComputeOrganizationSecurityPoliciesMoveRequest(
            securityPolicy='999999999999', parentId='organizations/12345'),
    ...
    self.AssertErrContains('Move the organization Security Policy.')


class OrgSecurityPoliciesMoveAlphaTest(OrgSecurityPoliciesMoveBetaTest):
