...
"""Tests for the organization security policy delete subcommand."""
...
class OrgSecurityPoliciesDeleteBetaTest(sdk_test_base.WithFakeAuth,
  ...
  def testDeleteOrgSecurityPolicy(self):
    self.mock_client.organizationSecurityPolicies.Delete.Expect(
        self.messages.ComputeOrganizationSecurityPoliciesDeleteRequest(
    ...
    self.Run('compute org-security-policies delete 99999999999')
    self.AssertOutputEquals('')
    self.AssertErrContains('Delete the organization Security Policy.')


class OrgSecurityPoliciesDeleteAlphaTest(OrgSecurityPoliciesDeleteBetaTest):
