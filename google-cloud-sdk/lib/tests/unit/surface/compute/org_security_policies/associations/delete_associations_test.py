...
class OrgSecurityPoliciesAssociationsDeleteBetaTest(sdk_test_base.WithFakeAuth,
  ...
  def testAssociationsDeleteOrgSecurityPolicy(self):
    self.mock_client.organizationSecurityPolicies.RemoveAssociation.Expect(
        self.messages
        .ComputeOrganizationSecurityPoliciesRemoveAssociationRequest(
            securityPolicy='12345678910', name='associ-name'),
    ...
    self.AssertErrContains(
        'Delete association of the organization Security Policy.')


class OrgSecurityPoliciesAssociationsDeleteAlphaTest(
    OrgSecurityPoliciesAssociationsDeleteBetaTest):
