...
class OrgSecurityPoliciesRulesCreateAlphaTest(test_base.BaseTest):
  ...
  def CheckOrgSecurityPolicyRequest(self, **kwargs):
    self.CheckRequests([
        (self.compute.organizationSecurityPolicies, 'AddRule',
  ...
  def testCreateOrgSecurityPolicyRule(self):
    ...
    self.Run(
        'compute org-security-policies rules create 10 '
        '--security-policy 12345 --action deny --direction INGRESS --enable-logging'
    )
