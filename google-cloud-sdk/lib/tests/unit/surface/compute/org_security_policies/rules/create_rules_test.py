...
"""Tests for the organization security policy rules create subcommand."""
...
class OrgSecurityPoliciesRulesCreateBetaTest(sdk_test_base.WithFakeAuth,
  ...
  def testCreateOrgSecurityPolicyRule(self):
    self.mock_client.organizationSecurityPolicies.AddRule.Expect(
        self.messages.ComputeOrganizationSecurityPoliciesAddRuleRequest(
    ...
    self.Run('compute org-security-policies rules create 10 '
             '--security-policy 12345678910 --action deny --direction INGRESS '
             '--enable-logging')
    self.AssertOutputEquals('')
    self.AssertErrContains('Add a rule of the organization Security Policy.')


class OrgSecurityPoliciesRulesCreateAlphaTest(
    OrgSecurityPoliciesRulesCreateBetaTest):
