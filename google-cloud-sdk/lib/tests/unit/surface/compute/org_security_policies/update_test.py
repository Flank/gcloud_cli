...
"""Tests for the organization security policy update subcommand."""
...
class OrgSecurityPoliciesUpdateBetaTest(sdk_test_base.WithFakeAuth,
  ...
  def CreateTestOrgSecurityPolicyMessage(self, **kwargs):
    return self.messages.SecurityPolicy(description='test-description')
  ...
  def testUpdateOrgSecurityPolicyWithOrganization(self):
    ...
    self.mock_client.organizationSecurityPolicies.Patch.Expect(
        self.messages.ComputeOrganizationSecurityPoliciesPatchRequest(
            securityPolicy='12345678910',
            securityPolicyResource=self.CreateTestOrgSecurityPolicyMessage()),
    ...
    self.Run('compute org-security-policies update 12345678910 '
             '--description test-description')

    self.AssertOutputEquals('')
    self.AssertErrContains('Update the organization Security Policy.')


class OrgSecurityPoliciesUpdateAlphaTest(OrgSecurityPoliciesUpdateBetaTest):
