...
"""Tests for the maintenance policies list command."""
...
class ListTest(maintenance_policies_base.TestBase):
  ...
  def SetUp(self):
    ...
    self.mock_get_regional_resources.return_value = (
        resource_projector.MakeSerializable(self.maintenance_policies))
  ...
  def testList_Simple(self):
    ...
    self.mock_get_regional_resources.assert_called_once_with(
        service=self.compute.maintenancePolicies,
