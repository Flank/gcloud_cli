...
"""Tests for the instance-groups unmanaged remove-instances subcommand."""
...
class UnmanagedInstanceGroupsInstancesRemoveTest(test_base.BaseTest):

  def SetUp(self):
    self.SelectApi(API_VERSION)

  def testRemoveInstancesToInstanceGroup(self):
    self.Run("""
        compute instance-groups unmanaged remove-instances group-1
    ...
    self.CheckRequests(
        [(self.compute.instanceGroups,
          'RemoveInstances',
          self.messages.ComputeInstanceGroupsRemoveInstancesRequest(
  ...
  def testRemoveInstancesToInstanceGroupWithZonePrompt(self):
  ...
  def testRemoveInstancesToInstanceGroupInconsistentZones(self):
