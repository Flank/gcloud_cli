    ...
    with self.AssertRaisesToolExceptionRegexp(
      ...
      self.Run("""
          compute instance-groups unmanaged add-instances
            https://compute.googleapis.com/compute/{0}/projects/my-project/zones/central2-a/instanceGroups/group-1
            --instances
              https://compute.googleapis.com/compute/{0}/projects/my-project/zones/central2-a/instances/inst-1,https://compute.googleapis.com/compute/{0}/projects/my-project/zones/central1-a/instances/inst-2,https://compute.googleapis.com/compute/{0}/projects/my-project/zones/central2-a/instances/inst-3
          """.format(API_VERSION))
