...
class InstanceGroupsListInstancesAlphaZonalTest(test_base.BaseTest):
    ...
    self.make_requests.side_effect = iter([
        [
            self.messages.InstanceGroupManagersListManagedInstancesResponse(
                managedInstances=(
                    test_resources.MakeInstancesInManagedInstanceGroupAlpha(
...
class InstanceGroupsListInstancesAlphaRegionalTest(test_base.BaseTest):
