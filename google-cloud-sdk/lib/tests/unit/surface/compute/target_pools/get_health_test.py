...
HEALTH_1 = messages.TargetPoolInstanceHealth(
...
HEALTH_2 = messages.TargetPoolInstanceHealth(
    healthStatus=[messages.HealthStatus(
...
OUTPUT = textwrap.dedent("""\
    ...
    - healthState: UNHEALTHY
      instance: https://www.googleapis.com/compute/v1/projects/my-project/zones/zone-1/instances/instance-2
      ipAddress: 23.251.133.76
    """)
  ...
  def testUriSupport(self):
    self.Run("""
        compute target-pools get-health
          https://www.googleapis.com/compute/v1/projects/my-project/regions/region-1/targetPools/target-pool-1
        """)
