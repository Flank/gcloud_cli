...
"""compute instance templates remove-iam-policy-binding tests."""
...
class RemoveIamPolicyBindingTest(sdk_test_base.WithFakeAuth,
  ...
  def testRemoveOwnerFromInstanceTemplate(self, track, api_version):
    ...
    self.Run("""
        compute instance-templates remove-iam-policy-binding my-resource
