...
"""compute instance templates get-iam-policy tests."""
...
class GetIamPolicyUnitTest(sdk_test_base.WithFakeAuth,
  ...
  def testEmptyPolicyCase(self, track, api_version):
    ...
    self.Run('compute instance-templates get-iam-policy my-resource')
  ...
  def testListCommandFilter(self, track, api_version):
    ...
    self.Run("""
        compute instance-templates get-iam-policy my-resource
