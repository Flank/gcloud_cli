...
"""Tests for the images remove-iam-policy-binding subcommand."""
...
class RemoveIamPolicyBindingTest(sdk_test_base.WithFakeAuth,
  ...
  def testRemoveOwnerFromImage(self, track, api_version):
    ...
    self.Run("""
        compute images remove-iam-policy-binding my-resource
