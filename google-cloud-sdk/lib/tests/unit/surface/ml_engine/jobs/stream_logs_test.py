...
"""ml-engine jobs stream-logs tests."""
import collections
...
class StreamLogsTestBase(object):
  """Tests 'ml-engine jobs stream-logs' command."""
  ...
  def testStreamLogs(self):
    self.Run('ml-engine jobs stream-logs myjob --allow-multiline-logs')
  ...
  def testStreamLogs_PollingIntervalProperty(self):
  ...
  def testStreamLogs_PollingIntervalFlag(self):
    self.Run('ml-engine jobs stream-logs myjob --allow-multiline-logs '
             '--polling-interval 20')
    self.log_fetcher_constructor_mock.assert_called_once_with(
        continue_func=mock.ANY,
  ...
  def testStreamLogsSingleLine(self):
    self.Run('ml-engine jobs stream-logs myjob')
...
class StreamLogsV2GaTest(StreamLogsTestBase, base.MlGaPlatformTestBase):

  def SetUp(self):
    base.MlGaPlatformTestBase.SetUp(self)
    StreamLogsTestBase.SetUpOutputs(self, _LOG_OUTPUTS_V2)


class StreamLogsGaTest(StreamLogsTestBase, base.MlGaPlatformTestBase):

  def SetUp(self):
    base.MlGaPlatformTestBase.SetUp(self)
    StreamLogsTestBase.SetUpOutputs(self, _LOG_OUTPUTS_V1)


class StreamLogsBetaTest(StreamLogsTestBase, base.MlBetaPlatformTestBase):

  def SetUp(self):
    base.MlBetaPlatformTestBase.SetUp(self)
    StreamLogsTestBase.SetUpOutputs(self, _LOG_OUTPUTS_V1)
