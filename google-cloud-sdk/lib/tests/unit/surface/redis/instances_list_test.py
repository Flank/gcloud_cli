...
class ListTestGA(redis_test_base.InstancesUnitTestBase):
  ...
  def testList(self):
    ...
    actual_instances = self.Run('redis instances list --region {}'.format(
        self.region_id))
  ...
  def testList_CheckFormat(self):
    ...
    self.AssertOutputEquals(
        ...
        {instance_id}_0  REDIS_3_2 us-central1  STANDARD_HA  4        10.0.0.0  6379  my-network  10.0.0.0/29  READY   2018-01-01T00:00:00
        {instance_id}_1  REDIS_3_2 us-central1  STANDARD_HA  4        10.0.0.0  6379  my-network  10.0.0.0/29  READY   2018-01-01T00:00:00
        {instance_id}_2  REDIS_3_2 us-central1  STANDARD_HA  4        10.0.0.0  6379  my-network  10.0.0.0/29  READY   2018-01-01T00:00:00
