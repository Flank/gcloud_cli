...
"""Tests for life sciences workflows run command."""
...
class RunTest(base.LifeSciencesUnitTest):
  """Unit tests for life sciences workflows run command."""
