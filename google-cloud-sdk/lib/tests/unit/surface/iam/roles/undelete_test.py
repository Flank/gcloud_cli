...
"""Tests that ensure undelete role command work properly."""
...
class UndeleteTest(unit_test_base.BaseTest):

  def testUndeleteRoles(self):
    self.client.organizations_roles.Undelete.Expect(
        request=self.msgs.IamOrganizationsRolesUndeleteRequest(
    ...
    self.Run('iam roles undelete --organization 819542162391 customEditor')
