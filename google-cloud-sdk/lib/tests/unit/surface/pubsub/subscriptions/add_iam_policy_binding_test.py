...
"""Test of the 'pubsub subscriptions add-iam-policy-binding' command."""
from googlecloudsdk.command_lib.pubsub import util
from tests.lib import test_case
from tests.lib.surface.pubsub import base


class SubscriptionsAddIamPolicyBindingTest(base.CloudPubsubTestBase):
  ...
  def testAddIamPolicyBinding(self):
    ...
    new_role = 'roles/pubsub.subscriber'
    ...
    result = self.Run(
        'pubsub subscriptions add-iam-policy-binding subs1 '
