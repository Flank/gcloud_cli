...
class KeysEncryptTestGA(base.KmsMockTest):
  ...
  def testEncryptWithNonPrimaryVersion(self):
    version_name = self.project_name.Version('global/my_kr/my_key/2')
...
class KeysEncryptTestBeta(KeysEncryptTestGA):

  def PreSetUp(self):
    self.track = calliope_base.ReleaseTrack.BETA


class KeysEncryptTestAlpha(KeysEncryptTestBeta):
