...
"""Tests for `gcloud access-context-manager perimeters dry-run commit`."""
...
class DryRunCommitTestBeta(accesscontextmanager.Base):
...
class DryRunCommitTestAlpha(DryRunCommitTestBeta):
