...
""",
  ...
  def testCreateMYSQL_5_6(self):
    ...
    command = 'sql instances create instance1 --database-version=MYSQL_5_6'
    self.Run(command)

    self.AssertOutputContains('instance1  MYSQL_5_6')

  def testCreateMYSQL_5_7(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    command = 'sql instances create instance1 --database-version=MYSQL_5_7'
    self.Run(command)

    self.AssertOutputContains('instance1  MYSQL_5_7')

  def testCreateMYSQL_8_0(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    command = 'sql instances create instance1 --database-version=MYSQL_8_0'
    self.Run(command)

    self.AssertOutputContains('instance1  MYSQL_8_0')

  def testCreatePOSTGRES_9_6(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    command = 'sql instances create instance1 --database-version=POSTGRES_9_6'
    self.Run(command)

    self.AssertOutputContains('instance1  POSTGRES_9_6')

  def testCreatePOSTGRES_10(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    command = 'sql instances create instance1 --database-version=POSTGRES_10'
    self.Run(command)

    self.AssertOutputContains('instance1  POSTGRES_10')

  def testCreatePOSTGRES_11(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    command = 'sql instances create instance1 --database-version=POSTGRES_11'
    self.Run(command)

    self.AssertOutputContains('instance1  POSTGRES_11')

  def testCreatePOSTGRES_12(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    command = 'sql instances create instance1 --database-version=POSTGRES_12'
    self.Run(command)

    self.AssertOutputContains('instance1  POSTGRES_12')

  def testCreateSQLSERVER_2017_EXPRESS(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    command = ('sql instances create instance1 '
               '--database-version=SQLSERVER_2017_EXPRESS '
               '--root-password=password')
    self.Run(command)

    self.AssertOutputContains('instance1  SQLSERVER_2017_EXPRESS')

  def testCreateSQLSERVER_2017_WEB(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    command = ('sql instances create instance1 '
               '--database-version=SQLSERVER_2017_WEB --root-password=password')
    self.Run(command)

    self.AssertOutputContains('instance1  SQLSERVER_2017_WEB')

  def testCreateSQLSERVER_2017_STANDARD(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    self.AssertOutputContains('instance1  SQLSERVER_2017_STANDARD')

  def testCreateSQLSERVER_2017_ENTERPRISE(self):
    diff = {
        'name':
            'instance1',
        'databaseVersion':
    ...
    self.AssertOutputContains('instance1  SQLSERVER_2017_ENTERPRISE')
...
""",
  ...
  def testCreateWithTier(self):
    diff = {'name': 'tiered-instance', 'settings': {'tier': 'db-n1-standard-2'}}
    self.ExpectInstanceInsert(self.GetRequestInstance(), diff)
    self.ExpectDoneCreateOperationGet()
    self.ExpectInstanceGet(self.GetV2Instance(), diff)
...
""",
  ...
  def testCreateWithRootPassword(self):
    diff = {'name': 'some-instance', 'rootPassword': 'somepassword'}
    self.ExpectInstanceInsert(self.GetRequestInstance(), diff)
    self.ExpectDoneCreateOperationGet()
...
class InstancesCreateGATest(_BaseInstancesCreateTest, base.SqlMockTestGA):
  ...
  def testCreateUnknownVersion(self):
    ...
    # Section for GA tests.
    # This section is auto-generated by //cloud/storage_fe/sql/sync_engines.
    # Do not make manual edits.
    choices = ('Valid choices are [MYSQL_5_6, MYSQL_5_7, MYSQL_8_0, '
               'POSTGRES_10, POSTGRES_11, POSTGRES_12, POSTGRES_9_6, '
               'SQLSERVER_2017_ENTERPRISE, SQLSERVER_2017_EXPRESS, '
               'SQLSERVER_2017_STANDARD, SQLSERVER_2017_WEB].')
    self.AssertErrContains(choices)
    # End of GA tests.

  # LINT.ThenChange(:version_tests)

  def testCreateWithCollation(self):
    diff = {
        'name': 'create-instance1',
        'settings': {
    ...
    self.ExpectInstanceInsert(self.GetRequestInstance(), diff)
    self.ExpectDoneCreateOperationGet()
    self.ExpectInstanceGet(self.GetSqlServerInstance(), diff)
    self.Run('sql instances create create-instance1 '
             '--collation=SQL_Latin1_General_CP1_CI_AS')
...
""",
  ...
  def testCreateMysqlWithBinLogAndNoBackup(self):
    with self.AssertRaisesExceptionRegexp(
      ...
      self.Run('sql instances create custom-instance1 '
               '--database-version=MYSQL_5_7 --memory=1024MiB --cpu=1 '
               '--enable-bin-log --no-backup')
...
class InstancesCreateAlphaTest(_BaseInstancesCreateBetaTest,
  ...
  def testCreateWithActiveDirectory(self):
    """Tests creating a domain-joined SQL Server instance.

    Expects that creating an instance with an Active Directory domain
    specified includes the domain name in the activeDirectoryConfig of the
    Insert request.
    """
    ...
    self.ExpectInstanceGet(self.GetSqlServerInstance(), diff)
    self.Run(
        'sql instances create custom-instance1 '
        '--database-version=SQLSERVER_2017_STANDARD '
        '--root-password=my-password '
        '--memory=4096MiB --cpu=1 '
        '--active-directory-domain=my-domain.com')
