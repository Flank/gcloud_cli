...
class UnregisterClusterTestBeta(cli_test_base.CliTestBase,
...
class UnregisterClusterTestAlpha(UnregisterClusterTestBeta):
...
if __name__ == '__main__':
  test_case.main()
# LINT.ThenChange(../memberships/unregister_test.py)
