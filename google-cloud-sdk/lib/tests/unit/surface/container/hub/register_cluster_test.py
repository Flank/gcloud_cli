...
class RegisterClusterTestBeta(cli_test_base.CliTestBase,
...
class RegisterClusterTestAlpha(RegisterClusterTestBeta):
...
if __name__ == '__main__':
  test_case.main()
# LINT.ThenChange(../memberships/register_test.py)
