...
class OperationsTestGA(base.GATestBase,
...
class OperationsTestBeta(base.BetaTestBase, OperationsTestGA):
  """gcloud Beta track using container v1beta1 API."""


# Mixin class must come in first to have the correct multi-inheritance behavior.
class OperationsTestAlpha(base.AlphaTestBase, OperationsTestBeta):
