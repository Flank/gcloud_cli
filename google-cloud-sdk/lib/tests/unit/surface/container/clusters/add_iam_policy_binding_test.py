...
class AddIamPolicyBindingTestAlphaV1Alpha1API(parameterized.TestCase,
                                              base.AlphaTestBase,
  ...
  def testAddIamPolicyBinding(self, location_flag, location):
    user = 'user:harry'
    ...
    self.Run('container clusters add-iam-policy-binding {} --member={} '
             '--role={} {} {}'.format(
