...
class ImplementationArgs(calliope_base.Command):
  ...
  def Args(parser):
    ...
    parser.add_argument('--flag', action='store_true', help='Auxilio aliis.')
    parser.add_argument(
        'implementation_args', nargs=argparse.REMAINDER, help='Auxilio aliis.')

  def Run(self, args):
    return args.implementation_args
