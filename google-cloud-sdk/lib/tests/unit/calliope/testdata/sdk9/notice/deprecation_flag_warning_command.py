...
class DeprecationFlagWarningCommand(calliope_base.Command):
  ...
  def Args(parser):
    ...
    parser.add_argument(
        ...
        action=calliope_actions.DeprecationAction(
            'testflag', removed=False, warn='{flag_name} is DEPRECATED.'),
  ...
  def Run(self, args):
    ...
    return 'Deprecation Flag Warning Command Complete'
