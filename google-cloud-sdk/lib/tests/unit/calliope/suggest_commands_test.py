  ...
  def testGetScoredCommandsContaining(self):
    self.assertEqual(
        [
            (['app', 'logs', 'read'], 100),
            (['app', 'logs', 'tail'], 100),
            (['logging', 'logs', 'delete'], 84),
            (['logging', 'logs', 'list'], 84),
            (['auth', 'application-default', 'login'], 72),
            (['app', 'browse'], 61),
            (['app', 'create'], 61),
            (['app', 'deploy'], 61),
            (['app', 'describe'], 61),
            ...
            (['logging', 'read'], 55),
            (['logging', 'write'], 55),
            (['app', 'domain-mappings', 'create'], 51),
            (['app', 'domain-mappings', 'delete'], 51),
            (['app', 'domain-mappings', 'describe'], 51),
            (['app', 'domain-mappings', 'list'], 51),
            (['app', 'domain-mappings', 'update'], 51),
            (['app', 'firewall-rules', 'create'], 51),
            (['app', 'firewall-rules', 'delete'], 51),
            (['app', 'firewall-rules', 'describe'], 51),
            (['app', 'firewall-rules', 'list'], 51),
            (['app', 'firewall-rules', 'test-ip'], 51),
            (['app', 'firewall-rules', 'update'], 51),
            (['app', 'instances', 'delete'], 51),
            (['app', 'instances', 'describe'], 51),
            (['app', 'instances', 'disable-debug'], 51),
            (['app', 'instances', 'enable-debug'], 51),
            (['app', 'instances', 'list'], 51),
            (['app', 'instances', 'scp'], 51),
            (['app', 'instances', 'ssh'], 51),
            (['app', 'operations', 'describe'], 51),
            (['app', 'operations', 'list'], 51),
            (['app', 'operations', 'wait'], 51),
            (['app', 'regions', 'list'], 51),
            (['app', 'services', 'browse'], 51),
            (['app', 'services', 'delete'], 51),
            (['app', 'services', 'describe'], 51),
            (['app', 'services', 'list'], 51),
            (['app', 'services', 'set-traffic'], 51),
            (['app', 'ssl-certificates', 'create'], 51),
            (['app', 'ssl-certificates', 'delete'], 51),
            (['app', 'ssl-certificates', 'describe'], 51),
            (['app', 'ssl-certificates', 'list'], 51),
            (['app', 'ssl-certificates', 'update'], 51),
            (['app', 'versions', 'browse'], 51),
            (['app', 'versions', 'delete'], 51),
            (['app', 'versions', 'describe'], 51),
            (['app', 'versions', 'list'], 51),
            (['app', 'versions', 'migrate'], 51),
            (['app', 'versions', 'start'], 51),
            (['app', 'versions', 'stop'], 51),
            (['builds', 'log'], 51),
            (['auth', 'login'], 47),
            (['logging', 'metrics', 'create'], 45),
            (['logging', 'metrics', 'delete'], 45),
            (['logging', 'metrics', 'describe'], 45),
            (['logging', 'metrics', 'list'], 45),
            (['logging', 'metrics', 'update'], 45),
            (['logging', 'resource-descriptors', 'list'], 45),
            (['logging', 'sinks', 'create'], 45),
            (['logging', 'sinks', 'delete'], 45),
            (['logging', 'sinks', 'describe'], 45),
            (['logging', 'sinks', 'list'], 45),
            (['logging', 'sinks', 'update'], 45),
            (['functions', 'logs', 'read'], 39),
            (['auth', 'application-default', 'print-access-token'], 35),
            (['auth', 'application-default', 'revoke'], 35),
            (['compute', 'os-login', 'describe-profile'], 35),
            (['compute', 'os-login', 'remove-profile'], 35),
            (['debug', 'logpoints', 'create'], 35),
            (['debug', 'logpoints', 'delete'], 35),
            (['debug', 'logpoints', 'list'], 35),
            (['compute', 'os-login', 'ssh-keys', 'add'], 25),
            (['compute', 'os-login', 'ssh-keys', 'describe'], 25),
            (['compute', 'os-login', 'ssh-keys', 'list'], 25),
            (['compute', 'os-login', 'ssh-keys', 'remove'], 25),
            (['compute', 'os-login', 'ssh-keys', 'update'], 25),
